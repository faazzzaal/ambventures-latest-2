        ...
        >
          <SwiperSlide className="swiper-slide">
            <div className="mil-hover-card">
              ...
              <h5 className="mil-mb-30">Retail</h5>
              <p>
                1. IoT in retail includes smart shelves and inventory management
                systems.
                <br />
                2. Customer experience improvement through personalized shopping
                experiences.
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <div className="mil-hover-card">
              ...
              <h5 className="mil-mb-30">Energy Management</h5>
              <p>
                1. IoT plays a crucial role in optimizing energy consumption and
          ...
          <SwiperSlide className="swiper-slide">
            <div className="mil-hover-card">
              ...
              <h5 className="mil-mb-30">FLogistics and Supply Chain</h5>
              <p>
                1.IoT sensors and devices enhance visibility and traceability
          ...
          <SwiperSlide className="swiper-slide">
            <div className="mil-hover-card">
              ...
              <h5 className="mil-mb-30">Automotive</h5>
              <p>
                1. IoT is transforming the automotive industry with connected
                vehicles and smart transportation solutions.
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <div className="mil-hover-card">
              ...
              <h5 className="mil-mb-30">Financial Services (Fintech)</h5>
              <p>
                1. IoT is making an impact in the financial sector through

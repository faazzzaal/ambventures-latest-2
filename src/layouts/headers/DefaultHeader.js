      ...
      >
        ...
        <div className="container">
          <Link href="/" legacyBehavior>
            <a className="mil-logo" style={{ width: 175 }}></a>
          </Link>
            ...
            <nav>
              <ul>
                ...
                <li className="mil-has-children">
                  ...
                  <ul>
                    <li>
                      <Link href="solution-1" style={{ whiteSpace: "wrap" }}>
                        Technology Management and Advisory Services
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="service-4">Web Development</Link>
                    </li>
                    <li>
                      <Link href="service-3">Application Development</Link>
                    </li>
                    <li>
                      <Link href="solution-3">Custom Software Solution</Link>
                    </li>
                    <li>
                      <Link href="solution-2">
                        Cloud, Migration and Server Services
                      </Link>
                    </li>
                    <li>

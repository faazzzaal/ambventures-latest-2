      ...
      <PageBanner
        ...
        pageTitle={
          <span>
            ...
            <br /> Management and Advisory Services
          </span>
        }
      />
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="mil-hori-box mil-mb-30">
                ...
                <h5>
                  Why hire an internal IT person, when you can have an entire
                  team of IT experts for a fraction of the cost?
                </h5>
              </div>
            </div>
        ...
        <div className="container">
          <div className="mil-text-center mil-mb-90">
            <span className="mil-suptitle mil-suptitle-2 mil-mb-30">
              Managed services, It consulting and advisory Services{" "}
            </span>
            <h2>
      ...
      <section className="mil-p-120-90">
        ...
        <div className="container">
          ...
          <h2 className="mil-mb-90">
            Our <span className="mil-accent">Tech Stack</span>
          </h2>
